    ...
    public class TreeAction : DirectActionBase {
        ...
        private TreeNode getData(Boolean fresh) {
            ...
            if (rootNode == null || fresh) {
                ...
                child2_child6 = new TreeNode {
                    text = "Childs Child No. 6",
                    leaf = true,
                    id = "1/2/6"
                };
                child2_child5 = new TreeNode {
                    text = "Childs Child No. 5",
                    leaf = true,
                    id = "1/2/5"
                };
                child1_child4 = new TreeNode {
                    text = "Childs Child No. 4",
                    leaf = true,
                    id = "1/2/4"
                };
                child1_child3 = new TreeNode {
                    text = "Childs Child No. 3",
                    leaf = true,
                    id = "1/1/3"
                };
                child1_child2 = new TreeNode {
                    text = "Childs Child No. 2",
                    leaf = true,
                    id = "1/1/2"
                };
                child1_child1 = new TreeNode {
                    text = "Childs Child",
                    leaf = true,
                    id = "1/1/1"
                };
                ...
                child2 = new TreeNode {
                    ...
                    leaf = false,
                    id = "1/2",
                    children = child_children2
                };
                child1 = new TreeNode {
                    text = "FirstNode",
                    leaf = false,
                    id = "1/1",
                    children = child_children1
                };
