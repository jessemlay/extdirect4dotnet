<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Form.aspx.cs" Inherits="ExtDirect.Example.Form.Form" %>
...
<body>
    ...
    <script type="text/javascript" src="DirectForm.js"></script>
    <h1>Direct</h1>
    <p>The js is not minified so it is readable. See <a href="DirectForm.js">Direct.js</a>.</p>
    <p>Download Code <a href="Direct.zip">Direct.zip</a></p>
    <div id="cont" style=" margin-left:10px; margin-top:10px;"></div>
    </form>
</body>
</html>
